...
export const equalVector2d = (a: Vector2d | Vector2d, b: Vector2d | Vector2d) => a.x === b.x && a.y === b.y;

export const truncVector2d = (a: Vector2d | Vector2d, trunc = 10000) => {
  return {
...
export const clamp = (a: Vector2d | Vector2d, trunc = 10000): void => {
...
export const lerpVector2d = (a: Vector2d | Vector2d, b: Vector2d | Vector2d, t: number) => {
  return {
...
export const distanceSquaredVector2d = (a: Vector2d | Vector2d, b: Vector2d | Vector2d) => {
  return (a.x - b.x) * (a.x - b.x) + (a.y - b.y) * (a.y - b.y);
};

export const distanceVector2d = (a: Vector2d | Vector2d, b: Vector2d | Vector2d): number => {
  return Math.sqrt(distanceSquaredVector2d(a, b));
};

export const inDistanceVector2d = (
  origin: Vector2d | Vector2d,
  search: Vector2d | Vector2d,
  distance: number
): boolean => {
...
export const normalizeOrRandomizeVector2d = (vector: Vector2d | Vector2d, rand: Random): Vector2d => {
...
export const lengthVector2d = (vector: Vector2d | Vector2d): number => {
  return distanceVector2d(w({ x: 0, y: 0 }), vector);
};

export const rotationDegVector2d = (vector: Vector2d | Vector2d): number => {
  return (rotationVector2d(vector) * 180) / Math.PI;
};

export const rotationVector2d = (vector: Vector2d | Vector2d): number => {
  return Math.atan2(vector.y, vector.x);
};

export const normalizeSafeVector2d = (vector: Vector2d | Vector2d): Vector2d => {
  if (vector.x === 0 && vector.y === 0) {
    return w({ x: 0, y: 0 });
  }
  return normalizeVector2d(vector);
...
export const normalizeVector2d = (a: Vector2d | Vector2d): Vector2d => {
  const length = lengthVector2d(a);
  return w(trunc2d(a.x / length, a.y / length));
};

export const subtractVector2d = (a: Vector2d | Vector2d, b: Vector2d | Vector2d): Vector2d => {
  return w({
    x: a.x - b.x,
    y: a.y - b.y,
  });
...
export const addVector2d = (a: Vector2d | Vector2d, b: Vector2d | Vector2d, c?: Vector2d | Vector2d): Vector2d => {
  return w({
    x: a.x + b.x + (c?.x ?? 0),
    y: a.y + b.y + (c?.y ?? 0),
  });
};
export const scaleVector2d = (a: Vector2d | Vector2d, scale: number): Vector2d => {
  return w({
    x: a.x * scale,
    y: a.y * scale,
  });
...
export const angleOfVector2d = (a: Vector2d | Vector2d): number => {
  return angleBetweenVector2d(w({ x: 1, y: 0 }), a);
};

export const angleBetweenVector2d = (a: Vector2d | Vector2d, b: Vector2d | Vector2d): number => {
...
export const rotateDegVector2d = (a: Vector2d | Vector2d, degrees: number): Vector2d => {
  if (degrees % 360 === 0) {
    return w({
      ...a,
    });
...
export const multiplyVector2d = (a: Vector2d | Vector2d, b: Vector2d | Vector2d): Vector2d =>
  w({
    x: a.x * b.x,
    y: a.y * b.y,
  });

export const dotVector2d = (a: Vector2d | Vector2d, b: Vector2d | Vector2d): number => {
  return a.x * b.x + a.y * b.y;
};

export const rotateVector2d = (a: Vector2d | Vector2d, radians: number): Vector2d => {
  const cos = Math.cos(radians);
  const sin = Math.sin(radians);
  return w(trunc2d(a.x * cos - a.y * sin, a.x * sin + a.y * cos));
};

export const pointingTowardsVector2d = (a: Vector2d | Vector2d, b: Vector2d | Vector2d): boolean => {
  return dotVector2d(a, b) > 0;
};

export const pointTowardsVector2d = (
  origin: Vector2d | Vector2d,
  target: (Vector2d | Vector2d)[] | Vector2d | Vector2d
): Vector2d => {
  let dir = w({ x: 0, y: 0 });
...
export const seekTowardsVector2d = (origin: Vector2d | Vector2d, speed = 1, target: Vector2d | Vector2d) => {
...
export const RayBoxIntersectionPoint = (
  origin: Vector2d | Vector2d,
  direction: Vector2d | Vector2d,
  box: Box2d
): Vector2d => {
